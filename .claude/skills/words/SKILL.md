...
<!-- GENERATED by monty gen sync instruments=sha256:00264d65b858b85a -->
...
| **world** | `wor` | core | The database as ordinary Lua tables: an entity is a table, a field is a field, and an edge is a field whose value is another entity. It is the surface everyone outside this repo is shown, which is what keeps fact, attribute, assertion and pattern internal to how the thing is built rather than things a user must learn. | Could somebody write it without knowing the word "fact"? Then it is the world. |
