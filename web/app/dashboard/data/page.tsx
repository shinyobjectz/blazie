 ...
 *
 * It was the console's front page until the orbit took that spot, and the move
 * cost something worth naming: the rows are now one click away rather than
 * none. What is bought is that the front page answers a question this one
 * cannot — a table shows you one world, and the account you hold is several.
 *
