defmodule LazyRiver.Surface.Socket do
  @moduledoc """
  ...
  channel("watch:*", LazyRiver.Surface.WatchChannel)
  ...
  @impl true
  def id(socket), do: "caller:" <> LazyRiver.Authority.caller(socket.assigns.caller)
end
