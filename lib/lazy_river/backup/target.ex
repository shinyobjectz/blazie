defmodule LazyRiver.Backup.Target do
  @moduledoc """
  Where copies go. Three functions, because a backup needs no more.

  This is the same seam `LazyRiver.Store` is: nothing above it knows whether
...
defmodule LazyRiver.Backup.Target.Directory do
  @moduledoc """
